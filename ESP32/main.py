...
def interpreta_trama(tramaRx):
    ...
    try:
        ...
        #             print(" ")
            ...
            Vcarga2   = float(Vcarga2)
            Icarga2   = float(Icarga2)
            Carga1    = float(Carga1)
            Carga2    = float(Carga2)
            Iconsumo1 = float(Iconsumo1)
            Iconsumo2 = float(Iconsumo2)
            Consumo1  = float(Consumo1)
            Consumo2  = float(Consumo2)

            Vcarga1   = '{0:.2f}'.format(Vcarga1)
            Icarga1   = '{0:.2f}'.format(Icarga1)
            Vcarga2   = '{0:.2f}'.format(Vcarga2)
            Icarga2   = '{0:.2f}'.format(Icarga2)
            Carga1    = '{0:.2f}'.format(Carga1)
            Carga2    = '{0:.2f}'.format(Carga2)
            Iconsumo1 = '{0:.2f}'.format(Iconsumo1)
            Iconsumo2 = '{0:.2f}'.format(Iconsumo2)
            Consumo1  = '{0:.2f}'.format(Consumo1)
            Consumo2  = '{0:.2f}'.format(Consumo2)

            sensor_consumo_values['vdc_bat_comp1']   = Vcarga1
            sensor_consumo_values['idc_bat_comp1']   = Icarga1
            sensor_consumo_values['vdc_bat_comp2']   = Vcarga2
            sensor_consumo_values['idc_bat_comp2']   = Icarga2
            sensor_consumo_values['cbat_comp1']      = Carga1
            sensor_consumo_values['cbat_comp2']      = Carga2
            sensor_consumo_values['idc_siscomp1']    = Iconsumo1
            sensor_consumo_values['idc_siscomp2']    = Iconsumo2
            sensor_consumo_values['valcon_siscomp1'] = Consumo1
            sensor_consumo_values['valcon_siscomp2'] = Consumo2
